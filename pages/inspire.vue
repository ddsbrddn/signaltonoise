<template>
  <div class="">
    ...
    <section class="container mx-auto px-6 p-10">
      ...
      <div class="flex items-center flex-wrap mb-20">
        <div class="w-full md:w-1/2">
          ...
          <p class="text-gray-600 mb-8">Our Smart Health Monitoring Wristwatch is able to capture you vitals while you
            exercise. You can create different category of exercises and can track
            your vitals on the go.</p>
        </div>
        <div class="w-full md:w-1/2">
      ...
      <div class="flex items-center flex-wrap mb-20">
        ...
        <div class="w-full md:w-1/2 pl-10">
          ...
          <p class="text-gray-600 mb-8">Our Smart Health Monitoring Wristwatch can
        ...
        <div class="flex flex-wrap">
          <div class="w-full md:w-1/3 px-2 mb-4">
            <div class="bg-white rounded shadow py-2">
              <p class="text-gray-800 text-base px-6 mb-5">Monitoring and tracking
                my health vitals anywhere I go and on
    ...
    <footer class="bg-gray-100">
      <b-container class="mx-auto px-6 pt-10 pb-6">
        <b-row class="flex flex-wrap">
          <b-col class="w-full md:w-1/4 text-center md:text-left">
